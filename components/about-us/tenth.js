    ...
    <>
      <div className="bg-socs-bg bg-cover bg-center ">
        <div className="max-w-[1200px] mx-auto px-4 py-20">
          {/* Heading Section */}
          <h1 className="font-montserrat font700 text-[48px] text-center capitalize text-white leading-[1.3] m-0 pb-[20px]">
          Africa is our second home.
          </h1>
           <p className=" text-center text-sm sm:text-md md:text-[22px] text-white">Chin is very well name in Africa as a Safari Mentor.</p>
          {/* Content Section */}
          <div className="flex flex-col pt-12 md:flex-row gap-5">
            ...
            <div className="flex-1">
              ...
              <p className="mt-4 text-md font-semibold sm:text-base md:text-lg text-white">
              ...
              <div className="flex gap-2 items-center text-white text-lg sm:text-md mt-4">
