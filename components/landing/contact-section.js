      ...
      <div className="bg-gray-50 py-10 flex justify-center">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <a
            ...
            className="flex items-center gap-4 bg-white border border-gray-300 rounded-lg shadow-md p-4 hover:shadow-lg transition-shadow"
          >
            <img
            ...
            />
            <div>
              <p className="text-lg font-semibold text-gray-700">WhatsApp Directly</p>
          ...
          >
            ...
            />
            <div>
              <p className="text-lg font-semibold text-gray-700">Email Us Questions Here</p>
